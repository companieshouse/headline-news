# Code of conduct for `headline-news`

Contributors to this repository hosted by `companieshouse` are expected to follow the Contributor
...
- "Project", we mean this `headline-news` GitHub repository;
- "Maintainer", we mean the `companieshouse` organisation owners; and
- "Leadership", we mean both `companieshouse` organisation owners, line managers, and other
  leadership within CompaniesHouse.
...
[lwilliams2@companieshouse.gov.uk][email-address]. All complaints will be reviewed and investigated and
...
[email-address]: mailto:lwilliams2@companieshouse.gov.uk
